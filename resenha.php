    ...
    <body>
        ...
        <div class="imgResenha"><img src="img/imgProdutos/imgWire.jpg" alt="iphone-5-c"></div>
         ...
         <article class="qualidadesResenha">
            <h2 class="txtSessao">Qualidades</h2>
            <p class="txtqualidades">
            <ul class="ulPadrao ulqualidades">
                <li class="liQualidades">Qualidade 1</li>
                <li class="liQualidades">Qualidade 2</li>
                <li class="liQualidades">Qualidade 3</li>
                <li class="liQualidades">Qualidade 4</li>
            </ul>
            </p>
        </article>
        
        <article class="defeitosResenha">
            <h2 class="txtSessao">Defeitos</h2>
            
            <ul class="ulPadrao ulqualidades">
                <li class="liQualidades">Defeito 1</li>
                <li class="liQualidades">Defeito 2</li>
                <li class="liQualidades">Defeito 3</li>
                <li class="liQualidades">Defeito 4</li>
            </ul>
